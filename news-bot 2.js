...
const SOURCES = [
  ...
  { source: 'CNBC Finance',      url: 'https://www.cnbc.com/id/100003114/device/rss/rss.html' },
  ...
  { source: 'RBA (Australia)',   url: 'https://www.rba.gov.au/rss/rss-cb-media-releases.xml' },
...
async function classify(item) {
  const msg = await anthropic.messages.create({
    model: 'claude-3-5-haiku-latest', // cheap/fast rewrites (swap to 'claude-sonnet-4-6' for higher quality at ~12x cost)
    max_tokens: 400,
